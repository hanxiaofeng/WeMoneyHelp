...
public class Config {
    ...
    public static final String ACTION_LuckMoneyPlugin_SERVICE_DISCONNECT = "com.codeboy.LuckMoneyPlugin.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_LuckMoneyPlugin_SERVICE_CONNECT = "com.codeboy.LuckMoneyPlugin.ACCESSBILITY_CONNECT";

    public static final String ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT = "com.codeboy.LuckMoneyPlugin.NOTIFY_LISTENER_DISCONNECT";
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_CONNECT = "com.codeboy.LuckMoneyPlugin.NOTIFY_LISTENER_CONNECT";
    ...
    public static final String KEY_SOUND_TYPE_MODE = "KEY_SOUND_TYPE_MODE";
    ...
    public static final String KEY_NOTIFY_SOUND_TYPE = "KEY_NOTIFY_SOUND_TYPE";
    ...
    /** 获取红包提示声类型*/
    public int getNotifySoundType() {
        int defaultValue = 0;
        String result = preferences.getString(KEY_SOUND_TYPE_MODE, String.valueOf(defaultValue));
        try {
            return Integer.parseInt(result);
        } catch (Exception e) {}
        return defaultValue;
