...
public class HongbaoSignature {
    ...
    public boolean generateSignature(AccessibilityNodeInfo node, String excludeWords) {
        try {
            ...
            Log.e("wangkeke", " -------   hongbaoNode.getClassName() = "+hongbaoNode.getClassName());
            ...
            Log.e("wangkeke", " -------   hongbaoContent = "+hongbaoContent);
            ...
            for (int i = 0; i < hongbaoInfo.length; i++) {
                Log.e("wangkeke", " -------   hongbaoInfo["+i+"] = "+hongbaoInfo[i]);
            }
            ...
            Log.e("wangkeke", " -------  this.sender = "+this.sender);
            Log.e("wangkeke", " -------  this.time = "+this.time);
            Log.e("wangkeke", " -------  this.content = "+this.content);
